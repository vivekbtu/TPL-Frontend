...
export const Pagination = ({ totalPage, page, onChange }) => {
    ...
    return (
        <div className='pagination_div'>
            <button className='btn_prev' disabled={page == 1} onClick={() => onChange(page - 1)}></button>
            {pages}
            <button className='btn_next' disabled={page == totalPage} onClick={() => onChange(page + 1)}></button>
        </div>
    )
}